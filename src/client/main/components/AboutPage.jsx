  ...
  render () {
    return (
      <div className='aboutPage'>
        ...
        FreeCodeCamp. (<a href='https://www.freecodecamp.com/challenges/build-a-voting-app' target='_blank'>Link</a>)</p>
        <p>The source code is published on GitHub under a MIT license. (
        <a href='https://github.com/fcc-joemcintyre/pollster' target='_blank'>Link</a>)</p>
